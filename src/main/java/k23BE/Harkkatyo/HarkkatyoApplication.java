...
//	}
	...
	@Bean
	public CommandLineRunner demo(ProjektiRepository projektiRepository, AutoRepository autoRepository, TilaRepository tilaRepository) {
		return (args) -> {

			log.info("tallennetaan autot:");
			autoRepository.save(new Auto(null, "Veloster", null, null, 0, null));
			autoRepository.save(new Auto(null, "240sx", null, null, 0, null));
			autoRepository.save(new Auto("bmw", "x1", "1959", "Tiedot", 0.0, "kuva"));
